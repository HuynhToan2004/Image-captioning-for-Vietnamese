#!/bin/sh
CUDA_VISIBLE_DEVICES=0 torchrun --nproc_per_node=1 --master_port 29501 train_v2.py --seed 684331 \
--gpu_ids 0 --num_workers 16 \
--article_max_length 512 --caption_max_length 100 \
--plm_type facebook//mbart-large-cc25 \
--clip_type ViT-B-32 \
...
--no_clip_norm True \
--data_type vietnamese \
--data_dir /data/npl/ICEK/VACNIC/data/train \
--out_dir /output \
