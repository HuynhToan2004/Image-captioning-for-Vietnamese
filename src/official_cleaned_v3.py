...
parser.add_argument("--train_json", type=str, default='/data/npl/ICEK/Wikipedia/content/vacnic/final/mini_train.json')
parser.add_argument("--val_json", type=str, default='/data/npl/ICEK/Wikipedia/content/vacnic/final/mini_val.json')
parser.add_argument("--test_json", type=str, default='/data/npl/ICEK/Wikipedia/content/vacnic/final/mini_test.json')

parser.add_argument("--article_max_length", type=int, default=512)
parser.add_argument("--caption_max_length", type=int, default=100)
parser.add_argument("--plm_type", type=str, default="/data/npl/ICEK/License-Plate-Detection-Pipeline-with-Experiment-Tracking/assets/bartpho-syllable")
...
parser.add_argument("--base_dir", type=str, default= "/data/npl/ICEK/Wikipedia/content/vacnic")
parser.add_argument("--out_dir", type=str, default= "/data/npl/ICEK/Image-captioning-for-Vietnamese/output4")
...
def train_epoch(bart_model, model, loss_margin, loss_fn, loss_img_clip, loss_txt_clip, loss_clip_bart, train_dataloader, optimizer_bart, optimizer_clip, scheduler_bart, scheduler_clip, epoch, DEVICE):
    ...
    for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration")):
        ...
        wandb.log({"face name loss": face_name_loss})
...
def train(bart_model, model, loss_margin, loss_fn, loss_img_clip, loss_txt_clip, loss_clip_bart, train_dataloader, val_dataloader, test_dataloader, optimizer_bart, optimizer_clip, scheduler_bart, scheduler_clip, model_name, DEVICE):
    train_losses = []
    val_losses = []
    ...
    for epoch_i in range(int(args.num_epoch)):
        ...
        val_loss, out_dict = eval_epoch(model, loss_fn, loss_img_clip, loss_txt_clip, loss_clip_bart, val_dataloader, DEVICE)
...
if __name__ == "__main__":
    ...
    import os, json, types, re, torch, clip, wandb, partial
    import numpy as np
